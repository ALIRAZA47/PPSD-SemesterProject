...
// firstAccount of switch statement
    ...
    case 1:
    {
        ...
        cin >> NAME;
        Node*temp = firstAccount;                    // temp is the pointer which we use to find the required node
        if(temp->objectOfAccountClass.NameOfAccountHolder == NAME)
        {
    ...
    case 2:
    {
        ...
        cin >> number;
        Node*temp1 = firstAccount;
        if(temp1->objectOfAccountClass.AccountNumber == number)
        {
            firstAccount = firstAccount->getnext();
            return;
        }
    ...
    case 3:
    {
        ...
        cin >> mobilenumber;
        Node*temp2 = firstAccount;
        if(temp2->objectOfAccountClass.MobileNumber == mobilenumber)
        {
            firstAccount = firstAccount->getnext();
            return;
        }
    ...
    case 4:
    {
        ...
        cin >> cnic;
        Node*temp3 = firstAccount;
        if(temp3->objectOfAccountClass.CnicNumber== cnic)
        {
            firstAccount = firstAccount->getnext();
            return;
        }
